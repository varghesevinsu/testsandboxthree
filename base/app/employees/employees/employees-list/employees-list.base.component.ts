...
export class EmployeesListBaseComponent{
...
localStorageStateKey = "employees-list";
...
@ViewChild('toggleButton')
 ...
 filtersApplied:boolean = false;
  ...
  "groupOnColumn" : {
    "name" : "status",
    "sid" : "4ea46310-1473-434e-a373-e855fb05fa7a",
    "type" : "datamodelField"
  },
  "detailPage" : {
    "name" : "Employees Detail",
    "sid" : "37dbeab7-2a3b-4610-ad9e-661ccc519cbe",
    "url" : "/employees/employeesdetail"
  },
  "detailPageNavigation" : "click_of_the_row"
}
	pageViewTitle: string = 'EMPLOYEES_LIST';
...
public baseService = inject(BaseService);
 ...
 updateActions() {
  ...
  disablechildAction(pid?:any) {
      ...
      let property: Exclude<keyof EmployeesListBaseComponent, ' '> = value;
  ...
  this.clearFilterValues();
    ...
    const autoSuggestScrollSubscription = windowYOffsetObservable.subscribe((scrollPos: number) => {
      if ((tracker.offsetHeight + scrollPos >= tracker.scrollHeight)) {
        ...
        let action: Exclude<keyof EmployeesListBaseComponent, ' '> = methodName;
        this[action]();
      }
    });
