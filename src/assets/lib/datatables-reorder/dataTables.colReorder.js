...
var ColReorder = function( dt, opts )
{
    ...
    this.s = {
         ...
         *  @default  true
         */
        "allowReorder": !!dt.oInit.colReorder,
         ...
         *  @default  true
         */
        "allowResize": !!dt.oInit.colResize,
         ...
         *  @default  null
         */
        "reorderCallback": dt.oInit.colReorderResizeCallback,
         ...
         *  @default  null
         */
        "resizeCallback": dt.oInit.colReorderResizeCallback,
    ...
    "_fnMouseListener": function ( i, nTh )
    {
        ...
        $(nTh)
            .on( 'mousedown.ColReorder', function (e) {
                e.preventDefault();
                if (e.which == 1) {
                    downIndex = Number($(e.target).attr('data-column-index'))
        ...
        function addEventsHandler() {
          ...
          $(document)
              .on( 'mousemove.ColReorder touchmove.ColReorder', function (e) {
                  ...
                  that._fnMouseMove.call( that, e, downIndex);
              } )
    ...
    $.fn.dataTableExt.aoFeatures.push( {
        "fnInit": function( settings ) {
            ...
            if ( ! settings._colReorder ) {
                ...
                const obj = new ColReorder( settings, opts );
            }
            else {
